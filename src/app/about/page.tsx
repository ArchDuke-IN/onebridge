...
const values = [
  { num: '01', title: 'Radical Honesty', desc: 'No vanity metrics. No hiding behind impressions. If a campaign fails, we say so and pivot.' },
  { num: '02', title: 'Speed Over Polish', desc: 'Perfection belongs in galleries. In marketing, quick iterations win.' },
  { num: '03', title: 'Context Is King', desc: 'A great tactic fails if it doesn\'t fit your market. We learn your business first.' },
  { num: '04', title: 'Skin in the Game', desc: 'We act as your internal team. No finger-pointing. We own the results.' },
];
    ...
    <div className="flex flex-col w-full">
      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-20 md:pt-28 pb-16 md:pb-24 w-full">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-[var(--navy)] leading-[1.15] mb-6">Less Talk. More Work.</h1>
      ...
      <section className="border-t border-[var(--border)]">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20 w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <motion.div {...fadeUp}>
              <h2 className="text-2xl md:text-3xl text-[var(--navy)] mb-4">The Method.</h2>
            ...
            <div className="space-y-4">
              {[
                { label: 'Direct Alignment', body: 'If you don\'t make money, neither do we. The incentives are aligned.' },
                { label: 'Action Bias', body: 'Less meetings, more shipping. We get campaigns into the market fast.' },
      ...
      <section className="border-t border-[var(--border)]">
        <div className="max-w-[1200px] mx-auto px-6 py-16 md:py-20 w-full">
          <motion.div {...fadeUp} className="mb-12">
            <h2 className="text-2xl md:text-3xl text-[var(--navy)] mb-2">The Rules We Play By</h2>
            <p className="text-[var(--text)]">Good business is simple. Do what you say, don&apos;t hide behind jargon.</p>
          </motion.div>
