...
export function Footer() {
  return (
    <footer className="bg-[#F3EFE6] border-t-[1.5px] border-gray-900 w-full">
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-gray-500 hover:text-blue-600 transition-colors motion-duration-fast"
                aria-label="LinkedIn"
              >
          ...
          <div>
            <h4 className="font-bold text-gray-900 uppercase tracking-widest text-sm mb-6">Navigate</h4>
          ...
          <div>
            <h4 className="font-bold text-gray-900 uppercase tracking-widest text-sm mb-6">Contact</h4>
            <div className="flex flex-col space-y-4 text-sm">
              <a
                href={`mailto:${siteConfig.contact.email}`}
                className="text-gray-600 hover:text-blue-600 transition-colors motion-duration-fast"
              >
              ...
              <span className="text-gray-600">{siteConfig.location}</span>
            </div>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 mt-8 text-blue-600 font-bold hover:text-orange-500 transition-colors motion-duration-fast"
            >
        ...
        <div className="border-t border-gray-300 mt-16 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
